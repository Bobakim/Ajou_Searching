    ...
    def search_Ajou_Email():        # 아주대 이메일 모니터링 함수
        ...
        while True:
            ...
            if email_number == 0:
                ...
                email_number = driver.find_element_by_xpath("//*[@id='P031']/div/div/div/div/div/header/h2/span/i/em/span[1]").text.strip()
                email_title = "아주대 이메일 모니터링 시작"
                libg.send_gmail("mydasjun09@gmail.com", email_title, "내용 없음")
                print(email_number)
        
            else:
                if driver.find_element_by_xpath("//*[@id='P031']/div/div/div/div/div/header/h2/span/i/em/span[1]").text.strip() != email_number:
                    temp = int(driver.find_element_by_xpath("//*[@id='P031']/div/div/div/div/div/header/h2/span/i/em/span[1]").text.strip())
